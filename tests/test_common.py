...
<span class="logo" title="Web">🌐</span> <a class="h-card u-author" href="https://user.com/" title="user.com">user.com</a>""", common.pretty_link('https://user.com/', user=Web(id='user.com')),
        ignore_blanks=True)

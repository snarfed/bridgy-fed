...
htmlhelp_basename = 'bridgy-fed-doc'
...
latex_documents = [
  (master_doc, 'bridgy-fed.tex', 'Bridgy Fed Documentation',
   'Ryan Barrett', 'manual'),
]
...
man_pages = [
    (master_doc, 'Bridgy Fed', 'Bridgy Fed Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Bridgy Fed', 'Bridgy Fed Documentation',
   author, 'Bridgy Fed', 'One line description of project.',
   'Miscellaneous'),
]
